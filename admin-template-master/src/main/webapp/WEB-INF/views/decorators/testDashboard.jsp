                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header bg-light-blue">
                            <img src="${pageContext.request.contextPath}/resources/img/avatar3.png" class="img-circle" alt="User Image" />
                            <p>
                                ${loginUser.nickname} - Web Developer
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <c:forEach items="${gpList}" var="gp">
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-folder"></i> <span>${gp.groupName}</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">

                            <c:forEach items="${gp.fdList}" var="fd">
                                <li><a href="${pageContext.request.contextPath}/SingleChatRoom?otherId=${fd.fdLoginId}"><i class="fa fa-angle-double-right"></i> ${fd.fdNickName}</a></li>
                            </c:forEach>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search-btn").click(function () {
            ...
            $.ajax({
                type:"get",
                url:"${pageContext.request.contextPath}/searchUser?loginId="+searchId,
                success:function (result) {
                    result = JSON.parse(result);
                    if(confirm("确定要加"+result.nickname+"为好友吗")){
                        $.ajax({
                            type:"post",
                            ...
                            error:function () {
                                alert("ajax request fall");
                            }
                        });
                    }
                    else{
                        console.log("cancle add");
                    }
                },
                error:function (){
                    alert("ajax request fall");
