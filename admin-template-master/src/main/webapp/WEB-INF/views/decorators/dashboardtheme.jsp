                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span>${loginUser.nickname}<i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            ...
                            <a href="#"><i class="fa fa-circle text-success"></i> ${serverTime}</a>
                        </div>
                    </div>
                    <!-- search form -->
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <c:forEach items="${gp.fdList}" var="fd">
                                        <li><a href="${pageContext.request.contextPath}/SingleChatRoom?otherId=${fd.loginId}"><i class="fa fa-angle-double-right"></i> ${fd.fdNickName}</a></li>
                                    </c:forEach>
